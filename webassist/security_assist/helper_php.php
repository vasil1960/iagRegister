		...
		if (isset($WA_Auth_Parameter["usernameEncryption"]) && $WA_Auth_Parameter["usernameEncryption"]) {
			...
			switch ($useEncryption) {
				case "crypt":
					...
					break;
				case "hash":
			    $dataStr = $row_WA_Auth_RS[$WA_Auth_Parameter["toAddressColumn"]] . "|" . $row_WA_Auth_RS[$WA_Auth_Parameter["keyColumn"]] . "|" . WA_HashEncryption($row_WA_Auth_RS[$WA_Auth_Parameter["passwordColumn"]]) . "|" . $row_WA_Auth_RS[$WA_Auth_Parameter["usernameColumn"]];
